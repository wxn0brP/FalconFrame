...
export type ParseBodyFunction = (body: string, req: FFRequest, res: FFResponse) => Record<string, any> | Promise<Record<string, any>>;
...
export type EngineCallback = (path: string, data: any, callback: (e: any, rendered?: string) => void, FF?: FalconFrame) => void;
