...
import type { BeforeHandleRequest, BodyParserEntry, CombinedVars, EngineCallback, ErrorHandler, FFOpts, FFRequest, ParseBodyFunction, RouteHandler, StandardBodyParserOptions, ValidationErrorFormatter } from "./types.js";
export declare class FalconFrame<Vars extends Record<string, any> = {}> extends Router {
    ...
    addBodyParser(contentType: string, parser: ParseBodyFunction, opts?: StandardBodyParserOptions): this;
...
export { OfflineEngine, OfflineRequest, OfflineResponse } from "./engine.js";
