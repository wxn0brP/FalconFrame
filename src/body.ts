...
export function json(FF: FalconFrame<any>, opts: StandardBodyParserOptions = {}): RouteHandler {
    return getStandardBodyParser("application/json", (body) => JSON.parse(body), FF, opts);
}

export function urlencoded(FF: FalconFrame<any>, opts: StandardBodyParserOptions = {}): RouteHandler {
